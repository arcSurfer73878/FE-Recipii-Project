...
export default class CameraPage extends React.Component {
 ...
 render() {
  ...
  return <View style={styles.container}><Header rightComponent={{ icon: 'keyboard-arrow-right', color: '#fff', onPress: () => this.props.navigation.navigate('Home') }}
   centerComponent={{ text: "Camera", style: { color: 'black' } }} />{content}</View>;
 }
}
